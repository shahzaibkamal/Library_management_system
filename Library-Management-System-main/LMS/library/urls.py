...
from .views import return_issued_book
from .views import edit_issued


urlpatterns = [
    path('', views.index, name='index'),
    path('add_new_student', views.add_new_student, name='new_student'),
     path('edit/book/<uuid:id>/', views.edit_book, name='edit_book'),
    path('delete/book/<uuid:id>/', views.delete_book, name='delete_book'),
    ...
    path('return_issued_book/<int:id>/', return_issued_book, name='return_issued_book'),
    path('edit_issued/<int:id>/', edit_issued, name='edit_issued'),
    path('add_book_issue/', views.add_book_issue, name='add_book_issue'),
    path('edit_issued/<int:id>/', views.edit_issued, name='edit_issued'),
]
